...
> **Aviso importante.** euVWA es una aplicacion **deliberadamente vulnerable** creada con fines **educativos** para la asignatura Desarrollo Seguro de Web y Apps. La rama `main-vulnerable` contiene fallos de seguridad reales y explotables. No la despliegues en produccion ni la expongas a internet. Usala solo en local o en entornos de laboratorio controlados.
